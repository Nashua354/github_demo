...
// ignore: unused_element
  _Success success(UserData data) {
    return _Success(
      data,
    );
  }
...
mixin _$UserState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult success(UserData data),
  });
  @optionalTypeArgs
...
class __$SuccessCopyWithImpl<$Res> extends _$UserStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Success(
      data == freezed ? _value.data : data as UserData,
    ));
  }
...
abstract class _Success implements UserState {
  const factory _Success(UserData data) = _$_Success;
